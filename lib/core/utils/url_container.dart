class UrlContainer {
  static const String domainUrl = 'https://pothersathi.predictionbaba.in'; //YOUR WEBSITE DOMAIN URL HERE
  ...
  //Map related
  static const String getLocationByLatlng = '${baseUrl}get-location-by-lat-lng';
  static const String searchAddressByLocationName = '${baseUrl}search-address-by-location-name';
  static const String getPlaceDetails = '${baseUrl}get-place-details';
  static const String getDirection = '${baseUrl}get-direction';
  static const String getDirectionRoutesV2 = '${baseUrl}get-direction-by-route';
