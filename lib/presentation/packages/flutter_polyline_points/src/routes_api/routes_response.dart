...
class RoutesApiResponse {
  ...
  factory RoutesApiResponse.fromJson(Map<String, dynamic> json) {
    try {
      return RoutesApiResponse(
        routes: json['routes'] != null ? (json['routes'] as List).map((route) => Route.fromJson(route)).toList() : [],
        rawJson: json,
        status: json['status'],
  ...
  bool operator ==(Object other) {
    ...
    return other is RoutesApiResponse && _listEquals(other.routes, routes) && other.rawJson == rawJson && other.status == status && other.errorMessage == errorMessage;
  }
...
class Route {
  ...
  factory Route.fromJson(Map<String, dynamic> json) {
    ...
    return Route(
      duration: json['duration'] != null ? int.tryParse(json['duration'].toString().replaceAll('s', '')) : null,
      staticDuration: json['staticDuration'] != null ? int.tryParse(json['staticDuration'].toString().replaceAll('s', '')) : null,
      distanceMeters: json['distanceMeters'],
      polylineEncoded: polylineEncoded,
      polylinePoints: polylineEncoded?.isNotEmpty == true ? PolylineDecoder.run(polylineEncoded) : null,
    );
  }
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is Route && other.duration == duration && other.staticDuration == staticDuration && other.distanceMeters == distanceMeters && _listEquals(other.polylinePoints, polylinePoints) && other.polylineEncoded == polylineEncoded;
  }
