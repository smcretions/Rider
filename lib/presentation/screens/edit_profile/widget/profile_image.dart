...
import 'package:ovorideuser/presentation/screens/auth/profile_complete/widget/build_circle_widget.dart';
...
class _ProfileWidgetState extends State<ProfileWidget> {
  ...
  void _openGallery(BuildContext context) async {
    FilePickerResult? result = await FilePicker.pickFiles(allowMultiple: false, type: FileType.custom, allowedExtensions: ['png', 'jpg', 'jpeg']);
    setState(() {
