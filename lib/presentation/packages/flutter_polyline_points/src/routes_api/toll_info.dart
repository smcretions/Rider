...
class TollInfo {
  ...
  factory TollInfo.fromJson(Map<String, dynamic> json) {
    return TollInfo(
      estimatedPrice: json['estimatedPrice'] != null ? (json['estimatedPrice'] as List).map((cost) => TollCost.fromJson(cost)).toList() : null,
      hasTolls: json['hasTolls'] ?? false,
      applicableTollPasses: json['applicableTollPasses'] != null ? List<String>.from(json['applicableTollPasses']) : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      if (estimatedPrice != null) 'estimatedPrice': estimatedPrice!.map((cost) => cost.toJson()).toList(),
      'hasTolls': hasTolls,
      if (applicableTollPasses != null) 'applicableTollPasses': applicableTollPasses,
    };
  }
  ...
  double? getTotalCost([String? currencyCode]) {
    ...
    if (currencyCode != null) {
      final costs = estimatedPrice!.where((cost) => cost.currencyCode == currencyCode).toList();
    ...
    return estimatedPrice!.where((cost) => cost.currencyCode == firstCurrency).fold<double>(0.0, (sum, cost) => sum + cost.amount);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is TollInfo && _listEquals(other.estimatedPrice, estimatedPrice) && other.hasTolls == hasTolls && _listEquals(other.applicableTollPasses, applicableTollPasses);
  }
...
class TollCost {
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is TollCost && other.amount == amount && other.currencyCode == currencyCode && other.description == description && other.tollPlaza == tollPlaza;
  }
