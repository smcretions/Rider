...
class TrafficInfo {
  ...
  factory TrafficInfo.fromJson(Map<String, dynamic> json) {
    return TrafficInfo(
      overallCondition: TrafficCondition.fromString(json['overallCondition'] ?? 'UNKNOWN') ?? TrafficCondition.unknown,
      segments: json['segments'] != null ? (json['segments'] as List).map((segment) => TrafficSegment.fromJson(segment)).toList() : null,
  ...
  bool operator ==(Object other) {
    ...
    return other is TrafficInfo && other.overallCondition == overallCondition && _listEquals(other.segments, segments) && other.durationInTraffic == durationInTraffic && other.durationInTrafficText == durationInTrafficText && other.trafficDelay == trafficDelay && other.lastUpdated == lastUpdated;
  }
...
class TrafficSegment {
  ...
  factory TrafficSegment.fromJson(Map<String, dynamic> json) {
    return TrafficSegment(
      condition: TrafficCondition.fromString(json['condition'] ?? 'UNKNOWN') ?? TrafficCondition.unknown,
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is TrafficSegment && other.condition == condition && other.startPolylinePointIndex == startPolylinePointIndex && other.endPolylinePointIndex == endPolylinePointIndex && other.lengthMeters == lengthMeters && other.speedKmh == speedKmh;
  }
