...
class Data {
  ...
  Data({this.reviews, this.rider, this.driver, this.userImagePath, this.driverImagePath, this.userImageWithPath, this.vehicle});
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        vehicle: json["vehicle"] == null ? null : VehicleInfo.fromJson(json["vehicle"]),
      );
