...
class PolylinePoints {
  ...
  /// Custom network client for performing requests
  final PolylineNetworkClient? networkClient;
  ...
  Future<PolylineResult> getRouteBetweenCoordinates({
    ...
    if (networkClient != null) {
      return networkClient!.getRouteBetweenCoordinates(request);
    }
  ...
  Future<RoutesApiResponse> getRouteBetweenCoordinatesV2({
    ...
    if (networkClient != null) {
      return networkClient!.getRouteBetweenCoordinatesV2(request);
    }
  ...
  PolylineResult convertToLegacyResult(RoutesApiResponse response) {
    ...
    final points = route.polylineEncoded != null ? PolylineDecoder.run(route.polylineEncoded!) : <PointLatLng>[];
