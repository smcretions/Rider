...
class RouteModifiers {
  ...
  factory RouteModifiers.fromJson(Map<String, dynamic> json) {
    return RouteModifiers(
      ...
      tollPasses: json['tollPasses'] != null ? (json['tollPasses'] as List).map((pass) => TollPass.fromJson(pass)).toList() : null,
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is RouteModifiers && other.avoidTolls == avoidTolls && other.avoidHighways == avoidHighways && other.avoidFerries == avoidFerries && other.avoidIndoor == avoidIndoor && other.vehicleInfo == vehicleInfo && _listEquals(other.tollPasses, tollPasses);
  }
...
class VehicleInfo {
  ...
  factory VehicleInfo.fromJson(Map<String, dynamic> json) {
    return VehicleInfo(
      licensePlate: json['licensePlate'] != null ? LicensePlate.fromJson(json['licensePlate']) : null,
      emissionType: json['emissionType'] != null ? EmissionType.fromString(json['emissionType']) : null,
    );
  }
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is VehicleInfo && other.licensePlate == licensePlate && other.emissionType == emissionType;
  }
...
class LicensePlate {
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is LicensePlate && other.text == text && other.regionCode == regionCode;
  }
...
class TollPass {
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is TollPass && other.passId == passId && other.network == network;
  }
