...
class RoutesApiRequest {
  ...
  const RoutesApiRequest({
    ...
    this.headers,
          ...
          (travelMode != TravelMode.bicycling && travelMode != TravelMode.walking) || (routingPreference == RoutingPreference.unspecified),
  ...
  Map<String, dynamic> toJson() {
    ...
    if (extraComputations != null && extraComputations!.isNotEmpty) {
      json['extraComputations'] = extraComputations!.map((computation) => computation.value).toList();
    }
