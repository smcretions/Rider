...
class RequestConverter {
  ...
  static RoutesApiRequest convertToRoutesApi(PolylineRequest legacyRequest) {
    return RoutesApiRequest(
      ...
      departureTime: legacyRequest.departureTime != null ? DateTime.fromMillisecondsSinceEpoch(legacyRequest.departureTime! * 1000) : null,
      arrivalTime: legacyRequest.arrivalTime != null ? DateTime.fromMillisecondsSinceEpoch(legacyRequest.arrivalTime! * 1000) : null,
  ...
  static PolylineRequest convertToLegacy(RoutesApiRequest routesRequest) {
    return PolylineRequest(
      ...
      departureTime: routesRequest.departureTime?.millisecondsSinceEpoch != null ? (routesRequest.departureTime!.millisecondsSinceEpoch ~/ 1000) : null,
      arrivalTime: routesRequest.arrivalTime?.millisecondsSinceEpoch != null ? (routesRequest.arrivalTime!.millisecondsSinceEpoch ~/ 1000) : null,
  ...
  static bool canConvertToLegacy(RoutesApiRequest routesRequest) {
    ...
    if (routesRequest.routeModifiers?.tollPasses != null && routesRequest.routeModifiers!.tollPasses!.isNotEmpty) {
      return false; // Toll passes not supported in legacy API
    }

    if (routesRequest.extraComputations != null && routesRequest.extraComputations!.isNotEmpty) {
